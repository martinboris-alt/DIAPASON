...
export default function Footer() {
  ...
  return (
    <footer className="bg-piano-black border-t border-white/5 py-12 px-6">
        ...
        <nav className="flex gap-6 flex-wrap justify-center">
          {["Servicios", "Galería", "Sobre mí", "Contacto"].map((item) => (
            <button
              ...
              className="text-xs tracking-widest uppercase text-white/30 hover:text-gold transition-colors duration-300"
            >
              {item}
            </button>
          ))}
